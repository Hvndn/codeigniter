...
class IndexController extends CI_Controller
{
	public  function __construct()
	{
		...
		$this->load->model('ProductModel'); // Nạp model có tên là ProductModel
	...
	{
		$data['random_products'] = $this->ProductModel->get_random_products(6); // Gọi phương thức từ model
	...
	public function search()
	{
		...
		// load category để hiển thị menu
