		...
		<div class="card-body">
			...
			<form action="<?php echo base_url('product/update/' . $product->id) ?>" method="POST"
				...
				<div class="form-group">
					...
					<input type="text" name="title" value="<?php echo isset($product->title) ? $product->title : ''; ?>"
				...
				<div class="form-group">
					...
					<input type="text" name="quantity"
						value="<?php echo isset($product->quantity) ? $product->quantity : ''; ?>" class="form-control"
						id="exampleInputQuantity" aria-describedby="emailHelp">
				...
				<div class="form-group">
					...
					<input type="text" name="slug" readonly
						value="<?php echo isset($product->slug) ? $product->slug : ''; ?>" class="form-control"
						id="exampleInputSlug" aria-describedby="emailHelp">
				...
				<div class="form-group">
					...
					<input type="text" name="description"
						...
						class="form-control" id="exampleInputDescription" aria-describedby="emailHelp">
				...
				<div class="form-group">
					...
					<select class="form-control" name="category_id" id="exampleFormControlSelect1">
						<?php foreach ($category as $cate) { ?>
							<option <?php echo $cate->id == $product->category_id ? 'selected' : '' ?>
								value="<?php echo $cate->id ?>"><?php echo $cate->title ?></option>
						<?php } ?>
					</select>
				</div>
				<div class="form-group">
					...
					<select class="form-control" name="brand_id" id="exampleFormControlSelect1">
						<?php foreach ($brand as $bra) { ?>
							<option <?php echo $bra->id == $product->brand_id ? 'selected' : '' ?>
								value="<?php echo $bra->id ?>"><?php echo $bra->title ?></option>
						<?php } ?>
					</select>
				</div>
				<div class="form-group">
